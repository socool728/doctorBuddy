	...
	*/
	message = { 
		...
		select			: 'Please select an option',
                checkop                 : 'Please check an option'
...
alertTxt = ermsg;
		...
		date : function(a){validator.message['question'] = "Hello";
...
//                    alert('inbox');
//                    alert(a);
//alert(field.prop('checked'));
                    function validateCheck(name, value){
                                if(value==true){
                                    return true;
                                }else{
                                    return false;
                    ...
                    var res = validateCheck(field.prop('name'),field.prop('checked'));
//                    alert(cnt);
			if( res == false ){
                            cnt++;
//                            alert('test');
                            if(field.prop('class') == cnt){
                                cnt =0;
//                                alert('test');
				alertTxt = message.checkop;
				return false;
