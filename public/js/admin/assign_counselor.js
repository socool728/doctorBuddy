...
function assign_counselor()
 {    
    
    if (!validator.checkAll($("#assign_counselor_form"))) {   
        return false;
    }else{
...
//            $("#emailerr").hide();
            ...
            $.ajax({
            type: "POST",    
            data: $("#assign_counselor_form").serialize(),
            dataType: "json",
            url :SITE_URL+"/admin/assigncounselor/"+case_file_id+"/assign",
