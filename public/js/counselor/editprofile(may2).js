  ...
  $.ajax({
        ...
        success: function(data) {  
            if(data.state_exist){
               ...
               $("#state_1").hide();
               $("#state_2").html('<input  id="counselors_state_text" name="counselors_state_text"  title="State" class="frm-control" type="text" required="required">');
               $("#state_2").show();
            }
        }
        });  
      ...
      $.ajax({
        ...
        success: function(data) {  
            if(data.state_exist){
               ...
               $("#state_1").hide();
               $("#state_2").html('<input  id="counselors_state_text" name="counselors_state_text"  title="State" class="frm-control" type="text" required="required" value="'+stateName+'">');
               $("#state_2").show();
            }
        }
        }); 
