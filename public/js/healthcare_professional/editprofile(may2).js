  ...
  $.ajax({
        ...
        success: function(data) {  
            if(data.state_exist){
               ...
               $("#state_1").hide();
               $("#state_2").html('<input  id="healthcare_professional_state_text" name="healthcare_professional_state_text"  title="State" class="frm-control" type="text" required="required">');
               $("#state_2").show();
            }
        }
        });  
