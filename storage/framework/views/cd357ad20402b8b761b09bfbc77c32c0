        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                     ...
                     <li><a href="<?php echo url('admin/keyword'); ?>"><i class="fa fa-edit"></i>Keywords </a></li>
                     ...
                     <li><a href="<?php echo url('admin/reviews'); ?>"><i class="fa fa-edit"></i>Customer Reviews</a></li>
