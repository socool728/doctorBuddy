...
<section id="footer" class="col-lg-12 m-t-lg">
    ...
    <footer>
            ...
            <div class="col-lg-2 col-sm-2 col-sm-3">
            ...
            <div class="col-lg-2 col-sm-3 col-xs-12">
                   ...
                   <?php if(count($footermenus3)>0){
                     ...
                     ?>
                    <li><a href="<?php echo asset('home/contactus')?>">Contact Us</a></li>
                    </ul>
            ...
            <div class="col-lg-2 col-sm-3 col-xs-12">
                  ...
                  <div class="col-lg-2 col-sm-3 col-xs-12">
                    ...
                    <ul class="footer-nav">
						<h4>Terms &amp; Conditions</h4>
                   		<li><a href="<?php echo asset('home/contents/terms-conditions-customer')?>">Customer</a></li>

                    <li><a href="<?php echo asset('home/contents/terms-conditions-provider')?>">Counselors</a></li>
                    <li><a href="<?php echo asset('home/contents/terms-conditions-provider')?>">Provider</a></li>  
             ...
             <div class="col-lg-2 col-sm-3 col-xs-12">
                ...
                <div class="text-center"><a href="<?php echo asset('customer/register'); ?>"><img src="<?php echo asset('images/register-btn.png'); ?>" alt="Footer Logo"></a></div>
