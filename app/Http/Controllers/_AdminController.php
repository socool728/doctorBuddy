...
//        },array('except' => array('login','postLogin')));
    ...
    {
        $msg='';
        return View::make('admin.login')->with('error',$msg);
    }
...
//        $symptoms = DB::table('symptoms')->orderBy('symptom_id', 'DESC')->get();
    ...
    public function anyApproveHp($id=''){    
       if($id>0){
            ...
            Session::flash('flash_msg','Healthcare Professional has been approved successfully !');  
   ...
   public function anyLanguage($type='',$id=''){
    ...
    public function anyAssignprovider($customerDetailId,$type=''){
        ...
        default:
            $sql = "SELECT * FROM healthcare_professional WHERE healthcare_professional_status =1";
