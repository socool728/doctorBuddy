...
<section id="home" class="banner">
    ...
    <div class="banner-leftwrap">
        <div class="container">
            <div class="start">
                <p >Let your doctor know the changes within you<br/>
                Note the symptoms as it occurs! Never miss one!<br/>
                Get the updated prescription within minutes<br/>
                Let the doctor monitor as you are in ICU from your home!<br/>
                Check your pressure, sugar and get the doctor alerted when a changed in value occurs.<br/>
                Use test kits at home and inform the results.<br/>
                <strong>CONTINOUS MONITORING BY A DOCTOR - FEEL SAFE AND SECURE!</strong><br/>
                <div class="start-btn-box">
                <p>Get it in just &nbsp; &nbsp; &nbsp;<strong>steps</strong>! Click here to <a href="<?php echo asset('home/basic'); ?>" class="start-btn"></a></p>
            ...
            <div class="highlights">
                <h2>Our <strong class="redcolor">highlights</strong></h2>
                    <div class="highlights-box col-lg-8 pull-right">
                        <ul>
                            <li>+ Add new symptoms</li>
                            <li>+ Note the changes</li>
                            <li>+ Be in touch with your doctor</li>
                            <li>+ Take care of your parents from abroad</li>
                       </ul>
                   </div>
                   <div class="col-lg-8 pull-right text-right m-t no-pad"> <img src="<?php echo asset('images/chat-icon.png'); ?>" alt="Chat"></div></div>
            </div>
        </div>
    <div class="bottom-wrap">
        <img src="<?php echo asset('images/banner-shade.png'); ?>" class="img-responsive" alt="shade">
    </div>    
...
<div class="start-btn-box">
<span>Click here to <a href="<?php echo asset('home/basic'); ?>"><img src="<?php echo asset('images/start-btn.png'); ?>"></a></span>
</div>
</div>
...
<section class="pinkbg col-lg-12">
    <div class="container">
        ...
        <div class="col-lg-8"><img src="<?php echo asset('images/ISO.png'); ?>" class="img-responsive">
...
<div class="container">
  ...
  <img src="<?php echo asset('images/steps.png'); ?>" class="img-responsive" alt="Steps">
  <div class="steps">
          <ul>
  ...
  <div class="col-lg-4 our-con text-right"><img src="<?php echo asset('images/our-counselors.png'); ?>" class="img-responsive"></div>
  </div>
</div>
...
<section id="testimonial" class="pink-dark-bg testimonial col-lg-12">
                    ...
                    <?php } else { $margin = ""; } ?>    
                        ...
                        <div class="col-md-12 row <?php echo $margin ?>">
                            ...
                            <div class="profile-image">
                                <img alt="profile" class="m-b-md" src="<?php echo asset('uploads/testimonial'); ?>/<?php echo $testimonial->image ?>">
                            </div>
       ...
       <div class="col-lg-4 text-right testi-rg">
         <img src="<?php echo asset('images/testi-right-img.png'); ?>" class="img-responsive" alt="Testimonial -rightpart"></div>
       <div class="start-b"><p class="text-center">Click here to <a href="<?php echo asset('home/basic'); ?>" class="start-btn"></a></p></div>
       </div>
</section>
