...
<section class="show-mob">
  <div class="container">
    <div class="col-lg-12"><span><span class="grey-dark">Doctor Buddy helps you<br>
to take the right decision on <strong>treatments</strong>,<br>
Our numerous</span><span class="red"> <strong>experts</strong></span> can guide<br>
...
<section class="pinkbg col-lg-12">
    <div class="container">
        ...
        <div class="col-lg-6 col-xs-8 col-sm-6 row ISO">
        ...
        <div class="col-lg-6 col-xs-12 col-sm-6 row">
        <div class="features">
