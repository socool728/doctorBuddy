...
<h3>Conversation History<?php if( count($data['conversations'])>0) { ?>
                <div class="pull-right m-b">

                    <div class="left text-left">
                        <button type="button" class="btn btn-red" hp_id="<?php echo $data['healthcare_professional_id'];?>" flag="customer" customer_detail_id="<?php echo $data['customer_detail_id']; ?>" id="print_pdf_button"> Print PDF</button>
                    </div>
                    <div class="left text-left m-l propagation-area" id="propagation">
                    </div>
                </div>
            <?php } ?></h3>
 <div class="margin-top-20" style="border:1px solid #ddd;border-radius:10px;padding:10px;" >
        ...
        <?php if($conversation->customer_comment): ?>
            <div class="row  m-b m-l" >
                <div class="form-group">
                    <div class="col-lg-6  col-sm-6 col-xs-6 c_h_rows1">
                        <p><b>You</b></p> 
        ...
        <?php else: ?>
            <div class="row  m-b m-r">
                <div class="form-group">
                    ...
                    <div class="col-lg-6  col-sm-6 col-xs-6 c_h_rows2">
    ...
    <form action="javascript:void(0);" id="conversation_comment" name="conversation_comment"  method="post"  role="form" >
        ...
        <div class="col-lg-8   m-b col-sm-8 col-xs-8 m-b hide" id="openion-message">
            <div class="form-group">
                <div class="col-lg-12  col-sm-12 col-xs-12" id="openion-message-text"></div>
            </div>
        </div>

        <div class="row  m-b">
            <div class="form-group">
                <div class="col-lg-8  col-sm-8 col-xs-8  m-b item">
...
<script src="<?php echo asset('js/customer/conversation_pdf_print.js'); ?>"></script>
...
<script src="<?php echo asset('js/customer/conversation.js'); ?>"></script>
@stop