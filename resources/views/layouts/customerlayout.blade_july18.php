...
<html>
    ...
    <body>
        <div class="wrapper sub">
            ...
            <section>
                 <!--Remove right area, if customer dashboard sections -->
                <?php if(Session::get('customer_id') != '' || Session::get('hp_id') != ''|| Session::get('counselor_id') != ''): ?>
                    <div class="container-fluid  m-t">
                        <div class="col-lg-12 col-sm-12  col-sx-12 content-area" id="content-area">
                        @yield('content')
                        </div>
                    </div>                
                <?php else : ?>
                    <div class="container m-t">
                        <div class="col-lg-6 col-sm-12  col-xs-6 content-area" id="content-area">
                        @yield('content')
                        </div>
