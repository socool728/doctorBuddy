...
<html>
    <head>
        @include('includes.counselorhead')
    </head>
    <body>
        <div class="wrapper sub">
            ...
            <section>
                 <!--Remove right area, if counselor dashboard sections -->
                <?php if(Session::get('customer_id') != '' || Session::get('hp_id') != ''|| Session::get('counselor_id') != '' || Request::is('counselor/details/*') ||Request::is('counselor/listing')): ?>
