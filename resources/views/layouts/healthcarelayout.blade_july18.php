...
<html>
    <head>
        @include('includes.healthcarehead')
    </head>
    <body>
        <div class="wrapper sub">
            ...
            <section>
                 <!--Remove right area, if HP dashboard sections -->
                <?php if(Session::get('customer_id') != '' || Session::get('hp_id') != ''|| Session::get('counselor_id') != ''|| Request::is('healthcare_professional/details/*') ||Request::is('healthcare_professional/listing')): ?>
