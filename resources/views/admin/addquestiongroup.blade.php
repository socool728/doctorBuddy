...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Add Question Group <small></small></h2>
                    <div class="clearfix"> </div>
                </div>
                <div class="x_content">
                    <br></br>
...
<form class="form-horizontal form-label-left" novalidate  method="post" >
                        ...
                        <div class="item form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Question Group Name <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="symptom_name" class="form-control col-md-7 col-xs-12" data-validate-length-range="" title="Group name" name="group_name"  required="required" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <a href="../admin/questiongroup"><button type="button" class="btn btn-primary" name="cancel" id="cancel">Cancel</button></a>
