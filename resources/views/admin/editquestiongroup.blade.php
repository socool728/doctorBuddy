...
<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Edit Question Group <small></small></h2>
                    <div class="clearfix"> </div>
                </div>
                <div class="x_content">
                    <br></br>
                  ...
                  <form class="form-horizontal form-label-left" novalidate  method="post" >
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Question Group Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input data-parsley-id="3638" id="group_name" name="group_name" value="<?php echo $data['group_name'];?>" title="Group Name" required="required"  class="form-control col-md-7 col-xs-12" type="text"><ul id="parsley-id-3638" class="parsley-errors-list"></ul>
                             <input name="group_id" type="hidden" value="<?php echo $data['group_id'];?>" />
                        </div>
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            <a href="../questiongroup"><button type="button" class="btn btn-primary">Cancel</button></a>
