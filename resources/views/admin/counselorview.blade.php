                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    ...
                    <div class=" col-lg-3 col-sm-3 col-xs-12 text-center p-block">
                        <?php if(isset($counselorObject->counselors_photo) && $counselorObject->counselors_photo !='') : ?>
                            <img src="<?php echo asset("uploads/counselor/thumbnail")."/".$counselorObject->counselors_photo ?>"  class="img-circle circle-border m-b-md" alt="profile">
                        <?php else: ?>
  ...
  <abbr title="Phone">Email:</abbr> <?php echo $counselorObject->counselors_email_id ?>  
                    ...
                    <div class="col-lg-9 col-sm-9 col-xs-12">
                        ...
                        <div class="ibox-content">
                            <h3 class="detail_heading">About <?php echo $counselorName ?></h3>
                ...
                <div class="form-group">
                    <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
                        <a href="<?php echo asset('admin/counselor')?>">
                            <button type="button" class="btn btn-primary">Back</button>
                        </a>    
                        <a href="<?php echo asset('admin/casefiles/counselor/'.$counselorObject->counselors_id)?>">
