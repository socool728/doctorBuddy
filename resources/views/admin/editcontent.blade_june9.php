...
//                        foreach($data['contentObj']->content_position as $position){ 
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input data-parsley-id="3648" id="contents_key" name="contents_key" value="<?php echo $data['contentObj']->contents_key;?>" required="required" title="Content Title" class="form-control col-md-7 col-xs-12" type="text"><ul id="parsley-id-3638" class="parsley-errors-list"></ul>
                        </div>
                    </div>
                       <div class="item form-group">
