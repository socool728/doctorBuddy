        ...
        <form  action="javascript:void(0);" id="home_form" name="home_form" method="post"  class="form-horizontal">
            ...
            <div class="col-lg-8 here_lab">
                ...
                <div class="col-lg-11 no-pad">
                    ...
                    <!--<a tabindex="0" class="btn btn-lg btn-danger" role="button"  data-placement="top" data-toggle="popover" data-trigger="focus" title="Dismissible popover" data-content="And here's some amazing content. It's very engaging. Right?">Dismissible popover</a>-->
                    
                    <a class="info-icon" href="javascript:void(0);" data-container="body"  data-placement="top" data-toggle="popover" data-trigger="focus"  data-content="You can create case files for your family members or dependents. Healthcare professionals and school counselors can create case files for their clients or students. You can view, update and forward files to a new doctor any time in the future after logging in.">
