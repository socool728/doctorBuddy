...
<div>
    ...
    <table>
    <tr>
        <td><label>File No :<?php echo $report['customer_fileno'];$nil='-NIL-';?></label></td>
    </tr>  
    </table>   
    ...
    <div>
        ...
        <table class="list-casefile">
            ...
            <tr>
                <td><label class="label-left" >City :</label></td>
   ...
   <!-- Start :Symptoms Info --> 
    <div>
        ...
        <table class="list-casefile">
            ...
            <tr>
                <td><label class="label-left" >Let me help you further :</label></td>
                <td><label class="label-ans"> <?php echo (!empty($report['known_disease']))? ucfirst($report['known_disease']):$nil;?></label></td>
            </tr>
            ...
            <tr>
                ...
                <td><label class="label-ans"> <?php echo (!empty($report['customer_past_illness_history']))? ucfirst($report['customer_past_illness_history']):$nil;?></label></td>
            </tr>
            ...
            <tr>
                ...
                <td><label class="label-ans"> <?php echo (!empty($report['customer_hereditary_disease']))? ucfirst($report['customer_hereditary_disease']):$nil;?></label></td>
            </tr>
            <tr>
                <td><label class="label-left" >Present Medication :</label></td>
                <td><label class="label-ans"> <?php echo (!empty($report['customer_present_medication']))? ucfirst($report['customer_present_medication']):$nil;?></label></td>
            </tr>
      
            
            <tr>
                <td><label class="label-left" >Allergic Reaction :</label></td>
                <td><label class="label-ans"> <?php echo (!empty($report['customer_allergic_reaction']))? ucfirst($report['customer_allergic_reaction']):$nil;?></label></td>
            </tr>
    ...
    <div>
        ...
        foreach($report['answers'] as $answers){
             ...
             if (strpos($answers->question,'OPTION') !== false) {
               ...
               $answer = '<em style="color:#c84c4c;">'.$optionVal.'</em>';
