<div class="question question-wrapper" id="question">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="item form-group m-b-40">
                ...
                <div><textarea  data-parsley-id="3637" id="known_disease" name="known_disease" value="" class="form-control"></textarea></div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="item form-group">
                <label class="control-label" for="first-name">Symptom</label>
                <div>
