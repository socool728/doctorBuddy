<div class="col-lg-12 col-sm-12  m-t-xl left" >
    ...
    <div class="col-lg-12 col-sm-12  col-sx-12 m-t-xl registration-wrap left no-pad">
        ...
        <div class="col-lg-12 col-sm-12 col-sx-12 no-pad">
            <div class="form-group col-lg-6 col-sm-6 col-sx-12 no-pad  right-pad">
        ...
        <div class="col-lg-12 col-sm-12 col-sx-12 no-pad">
            <div class="form-group item">    
                <input type="checkbox" name="terms"  id="terms"  title="Terms & Conditions"  required="requiired"> 
                    <span>By checking this box, I acknowledge that I have read, understood and accepted the Official Essay Contest Rules 
                    <a href="javascript:void(0);"  onclick='window.open("<?php echo asset('home/contents/terms-conditions'); ?>");'>Terms & Conditions</a>  </span>
       ...
       <div id="usersection" <?php if(Session::get('customer_id')>0){?> class="hide" <?php } ?>>
        ...
        <div class="row " id="newuser" >
            ...
            <div class="col-lg-6">
                <div class="form-group item">
                    ...
                    <div class="alertuck" id="exister" >Email id exist.Please login Existing user.</div>
                </div>  
            </div>
            <div class="col-lg-6">
                <div class="form-group item">
        ...
        <div class="col-lg-12 col-sm-12 col-sx-12 no-pad" id="send_option_area">
            <div class="col-lg-12 no-pad">         
