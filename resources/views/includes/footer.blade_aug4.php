                  ...
                  <div class="col-lg-2 col-sm-3 col-xs-12">
                    ...
                    <ul class="footer-nav">
						<h4>Terms &amp; Conditions</h4>
                   		<li><a href="<?php echo asset('home/content/terms-conditions-customer')?>">Customer</a></li>

                    <li><a href="<?php echo asset('home/content/terms-conditions-provider')?>">Counselors</a></li>
                    <li><a href="<?php echo asset('home/content/terms-conditions-provider')?>">Provider</a></li>  
