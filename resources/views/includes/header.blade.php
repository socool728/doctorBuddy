...
<div class="container">
    ...
    <div class="social col-lg-4 pull-right text-right">
        <!--<a href="https://www.facebook.com/doctorbuddycom-1727232294191495/?fref=ts" target="_blank"><img src="<?php echo asset('images/facebook-icon.png'); ?>" alt="Facebook"></a>-->
        <a href="https://www.facebook.com/Doctorbuddy-324523137891748" target="_blank"><img src="<?php echo asset('images/facebook-icon.png'); ?>" alt="Facebook"></a>
        <a href="https://twitter.com/doctorbuddy1" target="_blank"><img src="<?php echo asset('images/tweet.png'); ?>" alt="Twitter"></a>
