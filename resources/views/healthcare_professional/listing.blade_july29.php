...
<div class="col-lg-6 col-sm-6  col-xs-6 no-pad m-b-lg search_box">
<form action="javascript:void(0);" id="hp_search_from" name="hp_search_from" class="form-label-left" method="post"  role="form" >
        <div class="col-lg-12 col-sm-12  col-sx-12 m-t-xl registration-wrap left no-pad">
           ...
           <div class="col-lg-12 col-sm-12 col-sx-12 no-pad">
                <div class="form-group col-lg-3 col-sm-3 col-sx-3 no-pad  right-pad">
                    <label>Country</label> 
                ...
                <div class="form-group col-lg-3 col-sm-3 col-sx-3 no-pad  left-pad">
                    <label>State</label>
                    <div  id="state_1" >
           ...
           <div class="col-lg-12 col-sm-12 col-sx-12 no-pad">
               <div class="col-lg-12 col-sm-12 col-xs-12 no-pad">
                    <button type="submit"  onclick="return search_hp();" title="Register"  class="btn btn-red" role="button">Submit</button>                   
               </div>   
