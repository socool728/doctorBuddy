...
<form action="javascript:void(0);" id="hpform" name="hpform" class="form-label-left" method="post"  role="form" >
        <div class="col-lg-12 col-sm-12  col-sx-12 m-t-xl registration-wrap left no-pad">
           ...
           <p>
               Are you an authorised healthcare provider in your area? If yes register here and get clients from around the world. Get the clients from your local area or seeking help in the area of your expertise. You or your receptionist can talk to
           </p>
           ...
           <div class="col-lg-12 col-sm-12 col-sx-12 no-pad">
                ...
                <div class="form-group col-lg-6 col-sm-6 col-sx-12 no-pad item left-pad">
                    ...
                    <input  id="healthcare_professional_phone_number" name="healthcare_professional_phone_number"  required="required" title="Phone Number" class="form-control" maxlength="11" max="99999999999" type="number">
                </div>
           </div>
           <div class="col-lg-12 col-sm-12 col-sx-12 no-pad">
                <div class="form-group col-lg-6 col-sm-6 col-sx-12 no-pad item right-pad">
