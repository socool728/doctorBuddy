            ...
            <div class="col-lg-12 col-sm-12  col-xs-12 registration-wrap  no-pad">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12 no-pad">
                        ...
                        <div class="form-group col-lg-6 col-sm-6 col-xs-12 no-pad item left-pad">
                            ...
                            ?>                            
                             <input  id="healthcare_professional_dob" name="healthcare_professional_dob"   title="Date Of Birth" class="form-control" type="text" value="<?php echo $dob ?>" readonly="true" required="required">
                        </div>
                        <div class="form-group col-lg-6 col-sm-6 col-xs-12 no-pad item left-pad">
                            <label>Fees</label> 
